...
@Data
public class PurchaseOrderDetailExportModel extends BaseBo<PurchaseOrderDetail> implements ExcelModel {
  ...
  public PurchaseOrderDetailExportModel() {
  }

  public PurchaseOrderDetailExportModel(PurchaseOrderDetail dto) {

    super(dto);
  }

  @Override
  public <A> BaseBo<PurchaseOrderDetail> convert(PurchaseOrderDetail dto) {

    return this;
  }

  @Override
  protected void afterInit(PurchaseOrderDetail dto) {
