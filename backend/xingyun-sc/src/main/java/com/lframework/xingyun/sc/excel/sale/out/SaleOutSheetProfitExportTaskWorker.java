...
public class SaleOutSheetProfitExportTaskWorker implements
    ExportTaskWorker<QuerySaleOutSheetVo, SaleOutSheet, SaleOutSheetProfitExportModel> {
  ...
  @Override
  public SaleOutSheetProfitExportModel exportData(SaleOutSheet data) {
    return new SaleOutSheetProfitExportModel(data);
  }

  @Override
  public Class<SaleOutSheetProfitExportModel> getModelClass() {
    return SaleOutSheetProfitExportModel.class;
  }
}
