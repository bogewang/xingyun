...
/** 报价单查询请求。 */ @Data public class QueryQuoteSheetVo extends SortPageVo { private String code; private String name; private QuoteSheetStatus status; private LocalDate startDate; private LocalDate endDate; }
