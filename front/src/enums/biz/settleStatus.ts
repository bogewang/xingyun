...
SETTLE_STATUS.set('UN_CHECK_BILL', new BaseEnumItem<number, string>(7, '待对账'));
SETTLE_STATUS.set('UN_SETTLE', new BaseEnumItem<number, string>(0, '待结算'));
SETTLE_STATUS.set('PART_SETTLE', new BaseEnumItem<number, string>(1, '部分结算'));
